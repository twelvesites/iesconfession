...
async function apiCall(method = "GET", body) {
  try {
    ...
    return { ok: false, confessions: [] };
  }
}

async function apiGet() { return apiCall("GET"); }
async function apiPost(body) { return apiCall("POST", body); }
async function apiPatch(body) { return apiCall("PATCH", body); }
async function apiDelete(body) { return apiCall("DELETE", body); }
